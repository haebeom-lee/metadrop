...
For example, 
```
$ python main.py --gpu_id 0 --savedir './results/metadrop/omni_5shot' --dataset 'omniglot' --mode 'export' --metabatch 6 --n_steps 5 --inner_lr 0.4 --way 20 --shot 5 --query 15 --n_train_iters 40000 --meta_lr 1e-3 --n_test_mc_samp 1
```

Then, run `plot.py` with `--savedir` argument.
For example,
```
$ python export --savedir './results/metadrop/omni_5shot'
```
